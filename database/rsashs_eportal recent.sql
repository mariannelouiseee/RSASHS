...
--
-- Host: localhost:3307
-- Generation Time: Mar 01, 2026 at 10:00 AM
...
(1293, 0, '', 'Failed login attempt: ID not found (Attempt 1/5)', '2026-02-26 05:40:39'),
(1294, 0, 'teacher', 'Logged in successfully', '2026-02-26 05:40:54'),
(1295, 0, '', 'Forced logout from another session', '2026-03-01 06:24:24'),
(1296, 0, 'teacher', 'Logged in successfully', '2026-03-01 06:24:30'),
(1297, 0, 'teacher', 'Logged in successfully', '2026-03-01 06:43:21'),
(1298, 0, 'teacher', 'Logged in successfully', '2026-03-01 06:51:04'),
(1299, 0, 'teacher', 'Logged in successfully', '2026-03-01 07:23:37'),
(1300, 0, 'teacher', 'Logged in successfully', '2026-03-01 08:13:34'),
(1301, 0, 'teacher', 'Logged out', '2026-03-01 08:14:02'),
(1302, 0, 'admin', 'Logged in successfully', '2026-03-01 08:18:05'),
(1303, 0, 'admin', 'Visited dashboard', '2026-03-01 08:18:05'),
(1304, 0, 'admin', 'Viewed teacher account: mmedrano905', '2026-03-01 08:18:16'),
(1305, 0, 'admin', 'Viewed teacher account: mmedrano905', '2026-03-01 08:20:00'),
(1306, 0, 'admin', 'Logged out', '2026-03-01 08:20:29'),
(1307, 0, 'admin', 'Logged in successfully', '2026-03-01 08:45:05'),
(1308, 0, 'admin', 'Visited dashboard', '2026-03-01 08:45:05'),
(1309, 0, 'admin', 'Posted Announcement: Sample', '2026-03-01 08:45:22');
...
(13, 'Sample', 'sample', 'published', 'announcement_69a3fca2cf63a9.91043200.jpg', '2026-03-01 16:45:22');
...
(49, 103728080009, 22, '2025-2026', 87.00, 98.00, 92.50, 92.50, 79.00, 89.00, 84.00, 84.00, 88.25, NULL, '2026-01-23 09:09:24', '2026-03-01 06:56:12'),
(51, 103728080011, 22, '2025-2026', 87.00, 81.00, 84.00, 84.00, 90.00, NULL, NULL, NULL, NULL, NULL, '2026-03-01 06:37:47', '2026-03-01 06:56:12');
...
(37, 'admin', '$2y$10$9nqJUJIw3.G9JnBkPZ34suiZsD3odKh1snFjBf78JFQ/uRkXXwmQW', 'admin', 'logged_in'),
...
--
ALTER TABLE `activity_logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1310;
...
--
ALTER TABLE `grades`
  MODIFY `grade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
